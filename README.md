...
- Auf Android vorhandene YouTube-Untertitel direkt mit eingebettetem `yt-dlp` ohne API-Schlüssel abrufen; Deutsch oder Englisch wählen. Mehrere Video-Links lassen sich auf einmal einfügen und nacheinander importieren. Überlappende Zeilen mancher automatisch erzeugter Untertitel werden bereinigt; ältere betroffene Quellen lassen sich lokal im Detail bereinigen. YouTube kann einzelne Abrufe begrenzen oder blockieren. Im Browser oder als Ausweichweg lassen sich `.vtt`- oder `.srt`-Dateien importieren.
